...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function createDshbCore(win) {
			...
			/**
			 * Caption-column pass for opted-in pages: a card whose content is a
			 * stacked text column (title over explanation — e.g. the archived-
			 * conversations rows) gets the same item-text / item-title / item-desc
			 * roles as a settings row, so the caption gap and typography stay in
			 * the design language everywhere.
			 */
